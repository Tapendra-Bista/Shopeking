class ApiList {
  static const baseUrl = "https://shop.ztoo.cloud";
 static const licenseCode = "n1o27uj1-r6j9-14e2-8269-p596n54092i189122";
  ...
  static const updateAddress = "$baseUrl/api/frontend/adBBdress/";
...
// admin
static const adminLogin = "$baseUrl/api/admin/product";
static const productList = "$baseUrl/api/admin/product";
static const productShow = "$baseUrl/api/admin/product/show/{product}";
static const productPost = "$baseUrl/api/admin/product";
static const productPut = "$baseUrl/api/admin/product/1";
}
